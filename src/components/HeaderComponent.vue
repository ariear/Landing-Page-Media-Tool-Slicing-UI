<template>
  <div class="py-[80px] relative">
    <img src="/socialmedia.png" class="absolute object-cover object-center w-[70%] left-0 right-0 bottom-0 top-0 m-auto -z-10 md:block hidden" alt="">
      <p class="font-title text-center text-[#FC881D] text-base md:text-lg">MANA SAYA TAU SAYA KAN PENCURRY</p>
    <p class="font-title font-normal text-white text-center mx-auto mt-2 md:mt-5 text-3xl md:text-5xl md:w-[680px] lg:text-6xl lg:w-[790px] px-3 md:px-0">Social Media Tool Yang Tidak Akan Memberikan Kamu Insight Apapun</p>
